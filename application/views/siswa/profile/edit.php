<div style="overflow-x: hidden">
	...
	foreach ($profile as $o) :
		?>
		<div class="back">
			<h2 class="text-center text-white pt-5">Edit Profile</h2>
		</div>
						...
						<div class="row">
							...
							<div class="col-12 mt-3 mb-5">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" placeholder="Ganti Nama" style="border: none; border-bottom: 1px solid #17a2b8; color: #17a2b8;" class="input-nama" value="<?php echo $o->nama_siswa; ?>" name="nama" data-toggle="popover" data-placement="top" data-content="Maaf nama kamu tidak bisa dirubah" readonly>
								</div>
							</div>
