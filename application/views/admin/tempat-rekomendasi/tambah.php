              ...
              <div class="form-group">
                ...
                <?php foreach ($jurusan as $j) : ?>
                  ...
                  <div class="custom-control custom-checkbox mb-3 text-white float-left">
                    <input type="checkbox" name="jurusan[]" value="<?php echo $j->nama_singkat ?>" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group input-group-alternative mb-4">
                ...
                <input class="form-control form-control-alternative" placeholder="Masukan Nama Pimpinan" type="text" name="pimpinan" required>
              </div>
            </div>
          </div>
