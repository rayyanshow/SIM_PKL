        ...
        <form action="<?php echo base_url('admin/tempatRekomendasi') ?>" method="post">
          <div class="row">
            ...
            <div class="col-md-1 ml--5">
              <a href="<?php echo base_url('admin/tambahRekomendasi') ?>" class="btn btn-default text-white" type="submit" data-toggle="tooltip" data-placement="top" title="Tambah Tempat">
