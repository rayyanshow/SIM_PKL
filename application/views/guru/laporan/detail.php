                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <?php endforeach; ?>
                            <h3 class="mb-0">Detail Kegiatan <b></b></h3>
                        </div>
                    </div>
                </div>
                                ...
                                foreach ($kegiatan as $a) : ?>
                                    <tr>
                                        ...
                                        <td scope="row" class="name">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <span class="mb-0 text-sm"><?= $a->nama_kegiatan ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td scope="row" class="name">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <span class="mb-0 text-sm"><?= $a->deskripsi_kegiatan ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td scope="row" class="name">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <span class="mb-0 text-sm"><?= $a->tgl_kegiatan ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td scope="row" class="name">
